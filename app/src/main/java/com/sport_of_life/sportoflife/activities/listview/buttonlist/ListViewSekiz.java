...
public class ListViewSekiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgramList.add(new Program(1, "Sevgili Spor Sever", "Aşağıdaki Program Size Orta Seviye Kol Çalışmasını Uygun Olarak Sunmaktadır", "Uygularken Dikkatli Olalım! Spor Hayattır! :)"));
        ...
        mProgramList.add(new Program(7, "Dips", "Dips Bench", "Toplam 3 Set"));
