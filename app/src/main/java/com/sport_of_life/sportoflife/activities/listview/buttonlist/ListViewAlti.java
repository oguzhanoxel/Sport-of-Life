...
public class ListViewAlti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgramList.add(new Program(1, "Sevgili Spor Sever", "Aşağıdaki Program Size Orta Seviye Sırt Çalışmasını Uygun Olarak Sunmaktadır", "Uygularken Dikkatli Olalım! Spor Hayattır! :)"));
        ...
        mProgramList.add(new Program(4, "Reverse Grip Pulldown", "Cable Side Area", "2x10 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(5, "Seated Cable Row", "Cable Calısması", "2x10 1x13 Toplam 3 Set"));
        mProgramList.add(new Program(5, "Dumblee Row", "10x2 Dumbell", "2x10 1x13 Toplam 3 Set"));
