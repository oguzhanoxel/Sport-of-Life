...
public class ListViewBes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgramList.add(new Program(1, "Sevgili Spor Sever", "Aşağıdaki Program Size Orta Seviye Omuz Çalışmasını Uygun Olarak Sunmaktadır", "Uygularken Dikkatli Olalım! Spor Hayattır! :)"));
        mProgramList.add(new Program(2, "Isınma", "Koşu Bandı", "15 Dk Hızlı Tempo"));
        mProgramList.add(new Program(3, "Machine Shoulder Press", "Press Makinası", "2x12 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(4, "Dumbell Front Raise", "5x2 10x2 Dumbell", "2x13 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(5, "Dumbell Side Lateral Raise", "5x2 10x2 Dumbell", "2x12 1x13 Toplam 3 Set"));
        mProgramList.add(new Program(6, "Barbell Upright-row", "Long Barbell", "2x10 1x13 Toplam 3 Set"));
        mProgramList.add(new Program(7,"Çıkış Isınması", "Koşu Bandı", "10 Dk Hızlı Tempo"));
