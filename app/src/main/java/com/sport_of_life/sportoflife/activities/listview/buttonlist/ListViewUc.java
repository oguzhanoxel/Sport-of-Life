...
public class ListViewUc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgramList.add(new Program(1, "Sevgili Spor Sever", "Aşağıdaki Program Size Kolay Seviye Sırt Çalışmasını Uygun Olarak Sunmaktadır", "Uygularken Dikkatli Olalım! Spor Hayattır! :)"));
        ...
        mProgramList.add(new Program(6, "Çıkış Isınması", "Koşu Bandı", "10 Dk Normal Tempo"));
