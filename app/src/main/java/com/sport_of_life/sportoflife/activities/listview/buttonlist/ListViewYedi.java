...
public class ListViewYedi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgramList.add(new Program(1, "Sevgili Spor Sever", "Aşağıdaki Program Size Orta Seviye Göğüs Çalışmasını Uygun Olarak Sunmaktadır", "Uygularken Dikkatli Olalım! Spor Hayattır! :)"));
        ...
        mProgramList.add(new Program(6, "Dumbell Pullover", "10x2 Dumbell", "2x15 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(7, "Dumbell Fly", "10x2 Dumbell", "2x15 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(8, "Dips", "Dips Center", "2x10"));
        mProgramList.add(new Program(9,"Çıkış Isınması", "Koşu Bandı", "10 Dk Hızlı Tempo"));
