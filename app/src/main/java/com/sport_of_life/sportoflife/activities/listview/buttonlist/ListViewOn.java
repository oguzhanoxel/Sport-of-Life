...
public class ListViewOn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgramList.add(new Program(1, "Sevgili Spor Sever", "Aşağıdaki Program Size Zor Seviye Sırt Çalışmasını Uygun Olarak Sunmaktadır", "Uygularken Dikkatli Olalım! Spor Hayattır! :)"));
        mProgramList.add(new Program(2, "Isınma", "Koşu Bandı", "15 Dk Hızlı Tempo"));
        mProgramList.add(new Program(3, "Seated Cable Lat Pulldown", "Oturarak Cable Cekis", "2x10 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(4, "Reverse Grip Pulldown", "Cable Side Area", "2x13 1x12 Toplam 3 Set"));
        mProgramList.add(new Program(5, "Seated Cable Row", "Cable Calısması", "2x15 1x13 Toplam 3 Set"));
        mProgramList.add(new Program(6, "Dumblee Row", "10x2 Dumbell", "2x15 1x13 Toplam 3 Set"));
        mProgramList.add(new Program(7, "DeadLift", "Long Bar", "Toplam 3 Set"));
        mProgramList.add(new Program(8, "Çıkış Isınması", "Koşu Bandı", "10 Dk Normal Tempo"));
