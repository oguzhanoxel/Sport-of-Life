...
public class ListViewBir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgramList.add(new Program(1, "Sevgili Spor Sever", "Aşağıdaki Program Size En Kolay Göğüs Çalışmasını Uygun Olarak Sunmaktadır", "Uygularken Dikkatli Olalım! Spor Hayattır! :)"));
        mProgramList.add(new Program(2, "Isınma", "Koşu Bandı", "15 Dk Hızlı Tempo"));
        mProgramList.add(new Program(3, "Chest Press", "Press Makinası", "2x10 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(4, "Incline Machine Press", "Press Makinası", "2x10 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(5, "Decline Machine Press", "Press Makinası", "2x10 1x15 Toplam 3 Set"));
        mProgramList.add(new Program(6, "Dips", "Dips Center", "2x10"));
