...
public class ListViewOnIki extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgramList.add(new Program(1, "Sevgili Spor Sever", "Aşağıdaki Program Size Zor Seviye Kol Çalışmasını Uygun Olarak Sunmaktadır", "Uygularken Dikkatli Olalım! Spor Hayattır! :)"));
        ...
        mProgramList.add(new Program(4, "Hummer Curl", "Kısa Bar", "2x13 1x16 Toplam 3 Set"));
        mProgramList.add(new Program(5, "Consantration Curl", "Dumbell", "2x16 1x12 Toplam 3 Set"));
        mProgramList.add(new Program(6, "Rope Pushdown", "Cable Calısması", "2x16 1x13 Toplam 3 Set"));
        mProgramList.add(new Program(7, "Skull Crushers", "Cable Calısması", "2x10 1x13 Toplam 3 Set"));
        mProgramList.add(new Program(8, "Dips", "Dips Bench", "Toplam 3 Set"));
        mProgramList.add(new Program(9, "Çıkış Isınması", "Koşu Bandı", "10 Dk Normal Tempo"));
